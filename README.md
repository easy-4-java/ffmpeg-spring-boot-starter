...
**Spring Boot Starter for ffmpeg**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/ffmpeg-spring-boot-starter)](https://github.com/easy-4-java/ffmpeg-spring-boot-starter)
...
> **Artifact ID**：`ffmpeg-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**ffmpeg-spring-boot-starter** is a Spring Boot starter that integrates **ffmpeg** for applications using ffmpeg. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume ffmpeg capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using ffmpeg |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for ffmpeg |
| JDK | `17` |
| Coordinates | `io.github.easy4j:ffmpeg-spring-boot-starter:2.3.x.20260527-SNAPSHOT` |
| Config Prefix | `ffmpeg` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers ffmpeg beans automatically |
| Property Binding | ✅ Stable | Binds `ffmpeg.*` to `FfmpegProperties` |
| `FfmpegTemplate` bean | ✅ Stable | Auto-registered via FfmpegAutoConfiguration |
...
|---|---|---|
| `FfmpegTemplate` | classpath + property | not created |
...
```java
@Autowired
private FfmpegTemplate aliyunOnsMqTemplate;
```
...
|---|---|---|:---:|---|:---:|
| `ffmpeg.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl ffmpeg-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `ffmpeg.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/ffmpeg-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/ffmpeg-spring-boot-starter)
